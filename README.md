# LightGBM Time Step Classifier in Scikit-learn

LightGBM Time Step Classifcation Model in Scikit-learn as per Ready Tensor specifications.
...
- A **LightGBM Time Step Classifcation n** model built using **Scikit-learn**
